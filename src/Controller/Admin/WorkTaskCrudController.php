...
class WorkTaskCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            DateTimeField::new('start_date', 'Дата начала задачи')->setRequired(true)->setFormat('Y-MM-dd HH:mm')->renderAsChoice(),
            DateTimeField::new('end_date', 'Дата окончания задачи')->setRequired(true)->setFormat('Y-MM-dd HH:mm')->renderAsChoice(),
